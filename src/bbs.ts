...
// NO options
type bbs_blind_signature_size_options = {}
...
type bbs_sign_context_init_options = {}
type bbs_sign_context_add_message_string_options = {}
type bbs_sign_context_add_message_bytes_options = {}
type bbs_sign_context_add_message_prehashed_options = {}
type bbs_sign_context_set_secret_key_options = {}
type bbs_sign_context_set_public_key_options = {}
type bbs_sign_context_finish_options = {}
...
type bls_public_key_to_bbs_key_options = {}
...
export interface Bbs {
  ...
  bbs_blind_signature_size(options: bbs_blind_signature_size_options): int32_t
  ...
  bbs_sign_context_init(options: bbs_sign_context_init_options): uint64_t
  ...
  bbs_sign_context_finish(options: bbs_sign_context_finish_options): int32_t
  ...
  bls_generate_g2_key(options: bls_generate_g2_key_options): int32_t
  bls_generate_g1_key(options: bls_generate_g1_key_options): int32_t
  bls_generate_blinded_g2_key(options: bls_generate_blinded_g2_key_options): int32_t
  bls_generate_blinded_g1_key(options: bls_generate_blinded_g1_key_options): int32_t
  ...
  bls_public_key_to_bbs_key(options: bls_public_key_to_bbs_key_options): int32_t
}
