...
void bbs_byte_buffer_free(ByteBuffer v);

void free_bbs_blind_commitment(uint64_t v, ExternError *err);

int32_t bbs_blind_signature_size();
...
void free_bbs_blind_sign(uint64_t v, ExternError *err);

int32_t bbs_blinding_factor_size();
...
int32_t bbs_blind_sign_context_set_public_key(uint64_t handle, ByteArray value, ExternError *err);

int32_t bbs_blind_sign_context_set_secret_key(uint64_t handle, ByteArray value, ExternError *err);

int32_t bbs_blind_sign_context_set_commitment(uint64_t handle, ByteArray value, ExternError *err);

int32_t bbs_blind_sign_context_finish(uint64_t handle,
                                      ByteBuffer *blinded_signature,
                                      ExternError *err);

int32_t bbs_unblind_signature(ByteArray blind_signature,
                              ByteArray blinding_factor,
                              ByteBuffer *unblind_signature,
                              ExternError *err);

void free_create_proof(uint64_t v, ExternError *err);
...
int32_t bbs_create_proof_context_set_signature(uint64_t handle, ByteArray value, ExternError *err);

int32_t bbs_create_proof_context_set_public_key(uint64_t handle, ByteArray value, ExternError *err);
...
void free_bbs_sign(uint64_t v, ExternError *err);

int32_t bbs_signature_size();

uint64_t bbs_sign_context_init(ExternError *err);

int32_t bbs_sign_context_add_message_string(uint64_t handle, FfiStr message, ExternError *err);

int32_t bbs_sign_context_add_message_bytes(uint64_t handle, ByteArray message, ExternError *err);

int32_t bbs_sign_context_add_message_prehashed(uint64_t handle,
                                               ByteArray message,
                                               ExternError *err);

int32_t bbs_sign_context_set_secret_key(uint64_t handle, ByteArray value, ExternError *err);

int32_t bbs_sign_context_set_public_key(uint64_t handle, ByteArray value, ExternError *err);
...
int32_t bbs_verify_context_add_message_string(uint64_t handle, FfiStr message, ExternError *err);

int32_t bbs_verify_context_add_message_bytes(uint64_t handle, ByteArray message, ExternError *err);

int32_t bbs_verify_context_add_message_prehashed(uint64_t handle,
                                                 ByteArray message,
                                                 ExternError *err);

int32_t bbs_verify_context_set_public_key(uint64_t handle, ByteArray public_key, ExternError *err);

int32_t bbs_verify_context_set_signature(uint64_t handle, ByteArray value, ExternError *err);

int32_t bbs_verify_context_finish(uint64_t handle, ExternError *err);

void free_verify_proof(uint64_t v, ExternError *err);

int32_t bbs_get_total_messages_count_for_proof(ByteArray proof);
...
int32_t bbs_verify_proof_context_set_proof(uint64_t handle, ByteArray value, ExternError *err);

int32_t bbs_verify_proof_context_set_public_key(uint64_t handle, ByteArray value, ExternError *err);
...
void free_verify_sign_proof(uint64_t v, ExternError *err);
...
int32_t bls_public_key_g2_size();

int32_t blinding_factor_size();

int32_t bls_public_key_g1_size();

int32_t bls_generate_g2_key(ByteArray seed,
                            ByteBuffer *public_key,
                            ByteBuffer *secret_key,
                            ExternError *err);

int32_t bls_generate_g1_key(ByteArray seed,
                            ByteBuffer *public_key,
                            ByteBuffer *secret_key,
                            ExternError *err);

int32_t bls_generate_blinded_g2_key(ByteArray seed,
                                    ByteBuffer *public_key,
                                    ByteBuffer *secret_key,
                                    ByteBuffer *blinding_factor,
                                    ExternError *err);

int32_t bls_generate_blinded_g1_key(ByteArray seed,
                                    ByteBuffer *public_key,
                                    ByteBuffer *secret_key,
                                    ByteBuffer *blinding_factor,
                                    ExternError *err);

int32_t bls_get_public_key(ByteArray secret_key, ByteBuffer *public_key, ExternError *err);

int32_t bls_secret_key_to_bbs_key(ByteArray secret_key,
                                  uint32_t message_count,
                                  ByteBuffer *public_key,
                                  ExternError *err);

int32_t bls_public_key_to_bbs_key(ByteArray d_public_key,
                                  uint32_t message_count,
                                  ByteBuffer *public_key,
                                  ExternError *err);
